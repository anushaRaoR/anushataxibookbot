# anushataxibookbot
It can create request to book a taxi
...
- Navigate to `anushataxibookbot` folder
- Select `anushataxibookbot.bot` file
...
msbot clone services --name "anushataxibookbot" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
